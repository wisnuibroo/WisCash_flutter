...
class TokenListrikPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TokenListrikController tokenListrikController =
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 4),
            MyTextField(
              controller: tokenListrikController.nomorMeterController,
            ...
            SizedBox(height: 4),
            MyTextField(
              controller: tokenListrikController.amountController,
            ...
            Obx(() {
              if (tokenListrikController.nomorTerakhir.isEmpty) {
                ...
                return MyText(
                  text: tokenListrikController.nomorTerakhir.value,
                  fontSize: 15,
                  fontWeight: FontWeight.normal,
                  color: Colors.black,
                );
            ...
            SizedBox(
              ...
              child: MyButton(
                onPressed: () {
                  tokenListrikController.handleTokenListrik(context);
                },
                textButton: "Bayar",
