...
class MyDonasiBottomSheet extends StatelessWidget {
  final String nominal;

  const MyDonasiBottomSheet({super.key, required this.nominal});

  @override
  Widget build(BuildContext context) {
    final donasiController = Get.put(DonasiController());
