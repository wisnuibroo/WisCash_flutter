...
class MyVoucherBottomSheet extends StatelessWidget {
  final String nominal;

  const MyVoucherBottomSheet({super.key, required this.nominal});

  @override
  Widget build(BuildContext context) {
    final voucherGoogleController = Get.put(VoucherGoogleController());
          ...
          Row(
            children: [
              ...
              Expanded(
                child: MyButton(
                  onPressed: () {
                    voucherGoogleController.handleVoucherGoogle(
                        context, nominalInt);
                  },
