...
class BpjsKetenagakerjaanController extends GetxController {
  ...
  void handleBPJSKetenagakerjaan(BuildContext context) {
    ...
    if (balanceController.balance.value < nominal) {
      _showErrorSnackbar('Saldo tidak cukup untuk membayar BPJS Ketenagakerjaan.');
      return;
    }
